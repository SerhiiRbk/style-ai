...
const FAQS: { q: string; a: string }[] = [
  {
    ...
    a: "Valetti is AI-assisted styling, presented through Carlo Valetti, our lead-stylist persona. Recommendations are generated by our analysis engine and each one comes with the reason behind it — we disclose the AI assistance openly.",
  },
  {
